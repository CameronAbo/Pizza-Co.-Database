...
INSERT INTO ORDER_ITEM (OrderID, LineNumber, ProductID, Quantity, ItemPrice, SpecialInstructions)
VALUES
(1, 1, 1, 1, 19.99, 'Extra cheese'),
(1, 2, 3, 1, 2.99, 'No ice'),
(2, 1, 2, 1, 16.99, 'Well done'),
(3, 1, 1, 1, 19.99, 'No olives');
